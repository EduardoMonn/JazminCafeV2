...
<body id="main-body">
	...
	<header class="header full-box bg-white">
		<div class="header-brand full-box">
			<a href="index.php">
				<img src="./assets/img/jazminCafeLogo.jpeg" alt="Designlopers" class="img-fluid">
			</a>
		</div>
		...
		<div class="header-options full-box">
			...
			<a href="bag.php" class="header-button full-box text-center" title="Carrito">
				...
				<span class="badge bg-primary rounded-pill bag-count">0</span>
			</a>
	...
	<div class="banner">
		<div class="banner-body">
			<h3 class="text-uppercase">Bienvenido(a) a Jazmín Café</h3>
			<p>El mejor café y la mejor calidad lo encuentras aquí</p>
			<a href="menu.php" class="btn btn-warning"><i class='fas fa-coffee fa-spin fa-lg'></i> &nbsp; Ir al menu</a>
		</div>
	</div>
	...
	<div class="container-fluid container-web-page">
		...
		<p class="text-center"><a href="menu.php" class="btn btn-primary"><i class="fas fa-hamburger fa-fw"></i> &nbsp;
				Ir al menu</a></p>
	</div>
		...
		<div class="row justify-content-md-center">
			...
			<div class="col-12 col-md-6">
				...
				<p class="text-justify">
					Crea tu cuenta para poder realizar pedidos
				</p>
				<p class="text-center">
					<a href="registration.php" class="btn btn-primary">Crear cuenta</a>
				</p>
			</div>
		</div>
	</div>
